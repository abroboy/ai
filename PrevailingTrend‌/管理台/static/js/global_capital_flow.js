...
function renderGlobalCapitalFlowModule(container) {
  ...
  const moduleHTML = `
    <div class="mb-4">
      <h4 class="fw-bold text-primary mb-3">全球资金流向</h4>
      <div class="row">
        <div class="col-md-8">
          <div class="card shadow-sm mb-4">
            ...
            <div class="card-footer bg-light">
              <div class="d-flex justify-content-between align-items-center">
                <small class="text-muted">最后更新: 2025-09-23 11:00</small>
                <div>
          ...
          <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
              <div class="row g-3">
                ...
                <div class="col-6">
                  <div class="border rounded p-3 text-center">
                    <h3 class="text-primary mb-0">1554.4</h3>
                    <small class="text-muted">净流入总额(亿美元)</small>
                  </div>
                </div>
                <div class="col-6">
                  <div class="border rounded p-3 text-center">
                    <h3 class="text-primary mb-0">350.7</h3>
